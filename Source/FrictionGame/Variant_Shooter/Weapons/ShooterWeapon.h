 ...
 */
UCLASS(abstract)
class FRICTIONGAME_API AShooterWeapon : public AActor
{
	GENERATED_BODY()
...
protected:
	...
	TArray<TSubclassOf<ANewBullet>> ProjectileClass;

	int32 currentBulletIndex = 0;
...
public:
	...
	void switchBullet(float change);
